...
using Content.Shared.Sunrise.CCVar;
...
namespace Content.Server.Sunrise.BansNotifications
{
    ...
    */
    ...
    public sealed class BansNotificationsSystem : EntitySystem
    {
        ...
        public override void Initialize()
        {
            ...
            _config.OnValueChanged(SunriseCCVars.DiscordBanWebhook, value => _webhookUrl = value, true);
